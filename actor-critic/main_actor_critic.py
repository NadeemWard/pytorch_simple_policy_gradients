...
experiment = Experiment(api_key=args.comet_apikey,\
    ...
    policy = Actor_Critic(state_dim, hidden_size, action_dim, baseline = args.baseline)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--baseline', type=bool, default = False, help = 'Whether you want to add a baseline or not')
